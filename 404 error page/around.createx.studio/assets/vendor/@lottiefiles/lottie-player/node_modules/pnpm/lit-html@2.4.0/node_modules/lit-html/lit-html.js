...
class V {
    ...
    v(t) {
        ...
        const {
            ...
            parts: e
        } = this._$AD, o = (null !== (i = null == t ? void 0 : t.creationScope) && void 0 !== i ? i : h).importNode(s, !0);
        A.currentNode = o;
        let n = A.nextNode(),
            l = 0,
            r = 0,
...
class N {
    ...
    $(t) {
        ...
        const {
            values: s,
            _$litType$: e
        } = t, o = "number" == typeof e ? this._$AC(t) : (void 0 === e.el && (e.el = C.createElement(e.h, this.options)), e);
...
export {
    L as _$LH, y as html, x as noChange, b as nothing, Z as render, w as svg
};
